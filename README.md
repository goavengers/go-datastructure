...
### <a name="linked_list"></a> :point_right: Связанные списки (Linked List)
...
<a name="linked_list_implementation"></a> **Реализация**
...
<a name="linked_list_interview"></a> **Вопросы о связанных списках, часто задаваемые на собеседованиях:**
