...
6. [Связанные списки (Linked Lists)](#linked_lists)
    ...
    3. [Реализация стека и очереди на основе связанных списков](#linked_lists_stack_queue)
    4. [Двусвязанные списки (Double Linked List)](#linked_lists_double)
    5. [Вопросы о связанных списках, часто задаваемые на собеседованиях](#linked_lists_interview)
7. Массивы
    1. [Реализация](#array_implementation)
    2. [Сложность](#array_complexity)
    3. [Вопросы о множествах, часто задаваемые на собеседованиях](#array_interview)
8. Деревья
    1. [Реализация](#tree_implementation)
    2. [Сложность](#tree_complexity)
    3. [Вопросы о множествах, часто задаваемые на собеседованиях](#tree_interview)
9. Боры
    1. [Реализация](#trie_implementation)
    2. [Сложность](#trie_complexity)
    3. [Вопросы о множествах, часто задаваемые на собеседованиях](#trie_interview)
10. Графы
    1. [Реализация](#graph_implementation)
    2. [Сложность](#graph_complexity)
    3. [Вопросы о множествах, часто задаваемые на собеседованиях](#graph_interview)
11. Хеш-таблицы
    1. [Реализация](#hash_table_implementation)
    2. [Сложность](#hash_table_complexity)
    3. [Вопросы о множествах, часто задаваемые на собеседованиях](#hash_table_interview)

Структуры данных играют важную роль в процессе разработки ПО, а еще по ним часто задают вопросы на собеседованиях для разработчиков. Хорошая новость в том, что по сути они представляют собой всего лишь специальные форматы для организации и хранения данных.

### <a name="why_are_structures_needed"></a> :confused: Зачем нужны структуры данных?
...
### <a name="most_popular_structures"></a> :yum: Наиболее распространенные структуры данных
...
### <a name="stack"></a> :point_right: Стек
...
### <a name="queue"></a> :point_right: Очередь
...
<a name="queue_implementation"></a> **Реализация**
<details>
  <summary>Скрытый код</summary>
...
<a name="queue_complexity"></a> **Сложность:**
...
<a name="queue_interview"></a> **Вопросы о стеке, часто задаваемые на собеседованиях:**
...
### <a name="sets"></a> :point_right: Множества (Sets)
...
<a name="sets_implementation"></a> **Реализация**
...
### <a name="linked_lists"></a> :point_right: Связанные списки (Linked List)
...
<a name="linked_lists_implementation"></a> **Реализация**
...
<a name="linked_lists_stack_queue"></a> **Реализация стека и очереди на основе связанных списков**
...
<details>
	<summary>Реализация структуры <b>Стек</b> с помощью связанного списка</summary>
...
<a name="linked_lists_complexity"></a> **Сложность:**
...
<a name="linked_lists_interview"></a> **Вопросы о связанных списках, часто задаваемые на собеседованиях:**
